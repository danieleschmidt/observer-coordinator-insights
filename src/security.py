...
class SecureDataProcessor:
    ...
    def secure_load_data(self, file_path: str, user_id: str = "system", 
        ...
        try:
            ...
            logger.error(f"Secure data loading failed: {str(e)} [correlation_id: {correlation_id}]")
            raise
    ...
    def secure_clustering_pipeline(self, df: pd.DataFrame, n_clusters: int, 
        ...
        try:
            ...
            logger.error(f"Secure clustering failed: {str(e)} [correlation_id: {correlation_id}]")
            raise
